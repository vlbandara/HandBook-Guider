...
import static org.springframework.shell.component.view.event.KeyEvent.Key.c;
import static org.springframework.shell.component.view.event.KeyEvent.Key.p;
...
public class ReferenceDocsLoader {
    ...
    public ReferenceDocsLoader(JdbcClient jdbcClient, VectorStore vectorStore, @Value("classpath:/docs/handbook1.pdf") Resource pdfResource) {
